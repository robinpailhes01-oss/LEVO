    ...
    <section style={{ background: "#f4f3ef", borderTop: "1px solid rgba(17,17,17,0.10)", borderBottom: "1px solid rgba(17,17,17,0.10)" }}>
      <div className="mx-auto max-w-container px-5 lg:px-12">
        <dl className="grid grid-cols-2 lg:grid-cols-4">
          {metrics.map((m, i) => (
            <ScrollReveal key={m.label} delay={i * 60} as="div">
              <div
              ...
              >
                <dd className="font-display text-[2.6rem] font-bold leading-none tracking-[-0.03em]" style={{ color: "#111111" }}>
                  <AnimatedCounter value={m.value} />
                </dd>
                <dt className="mt-3 font-body text-sm font-semibold" style={{ color: "#111111" }}>{m.label}</dt>
