...
export function CasesSection() {
  return (
    <section id="cas" className="py-28 sm:py-36" style={{ background: "#faf7f0" }}>
      <div className="mx-auto max-w-container px-5 lg:px-12">
        ...
        <ScrollReveal className="mb-16 flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <div className="flex gap-10">
            {kpis.map((k) => (
              <div key={k.label}>
                <p className="font-display text-3xl font-bold" style={{ color: "#0b1f4a" }}>
                  {k.value}
                </p>
                <p className="mt-0.5 font-body text-xs" style={{ color: "#8a96a8" }}>
                  {k.label}
                </p>
              </div>
            ))}
            ...
            <div className="grid lg:grid-cols-2">
              ...
              >
                ...
                >
                  ...
                  <strong style={{ color: "#0b1f4a", fontWeight: 600 }}>Léa</strong>,
                ...
                >
                  ...
                  <footer className="mt-3 font-body text-sm" style={{ color: "#8a96a8" }}>
                  ...
                  {features.map((f) => (
                    <li key={f} className="flex items-start gap-4">
                      <span
                        ...
                        style={{
                          border: "1px solid rgba(0,95,255,0.25)",
                          background: "rgba(0,95,255,0.08)",
                        }}
                      >
                        <Check size={11} strokeWidth={2.5} style={{ color: "#005fff" }} aria-hidden />
                      </span>
                      <span
