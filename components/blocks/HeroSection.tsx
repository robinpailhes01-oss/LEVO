...
export function HeroSection() {
  return (
    <section id="top" className="relative pt-32 pb-20 sm:pt-40 sm:pb-28" style={{ background: "#f4f3ef" }}>
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          >
            ...
            <span className="inline-block overflow-hidden">
              <motion.em
                className="inline-block not-italic font-display"
          ...
          >
            {["SUR-MESURE", "40H+ ÉCONOMISÉES", "SANS ENGAGEMENT", "RÉSULTATS CONCRETS"].map((item) => (
              <span key={item} className="flex items-center gap-2 font-body text-[11px] font-semibold tracking-[0.12em]" style={{ color: "rgba(17,17,17,0.40)" }}>
                <span className="h-1 w-1 rounded-full" style={{ background: "rgba(17,17,17,0.35)" }} />
                {item}
              </span>
            ))}
          </motion.div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 p-6">
              <div className="flex items-center gap-3 pb-4" style={{ borderBottom: "1px solid rgba(17,17,17,0.07)" }}>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    />
                    <span className="font-body text-[10px]" style={{ color: "rgba(17,17,17,0.40)" }}>En ligne · répond en &lt; 5s</span>
                  </div>
                </div>
              </div>

              {/* Messages */}
              <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 0.9 }} className="flex gap-3">
              ...
              <motion.div initial={{ opacity: 0, x: 8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.2 }} className="flex justify-end gap-3">
              ...
              <motion.div initial={{ opacity: 0, x: -8 }} animate={{ opacity: 1, x: 0 }} transition={{ delay: 1.5 }} className="flex gap-3">
                <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full" style={{ background: "rgba(17,17,17,0.07)" }}>
                  <Bot size={13} style={{ color: "#111111" }} />
                </div>
                <div className="max-w-sm rounded-2xl rounded-tl-none px-4 py-3" style={{ background: "#f0ede6" }}>
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.8 }} className="flex gap-2 pt-1">
                {["Voir les yachts disponibles", "Modifier les dates"].map((label) => (
                  <button key={label} className="rounded-full px-3 py-1.5 font-body text-[10px] font-medium" style={{ border: "1px solid rgba(17,17,17,0.15)", color: "rgba(17,17,17,0.65)" }}>
                    {label}
                  </button>
                ))}
              </motion.div>
