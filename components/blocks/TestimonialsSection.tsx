        ...
        <div className="grid gap-px md:grid-cols-3" style={{ background: "rgba(17,17,17,0.10)" }}>
          {testimonials.map((t, i) => (
            <ScrollReveal key={t.name} delay={i * 80}>
              <div className="flex h-full flex-col p-10" style={{ background: "#f4f3ef" }}>
                ...
                <p className="flex-1 font-display text-xl italic leading-snug" style={{ color: "#111111" }}>
                  &laquo;&nbsp;{t.quote}&nbsp;&raquo;
                </p>

                <div className="mt-8 flex items-center justify-between pt-6" style={{ borderTop: "1px solid rgba(17,17,17,0.10)" }}>
                  <div className="flex items-center gap-3">
                    <span className="flex h-9 w-9 items-center justify-center rounded-full font-body text-xs font-bold text-white" style={{ background: "#111111" }}>
                      {t.initials}
                    </span>
                    <div>
                      <p className="font-body text-sm font-semibold" style={{ color: "#111111" }}>{t.name}</p>
