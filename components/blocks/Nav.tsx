    ...
    >
      <nav className="mx-auto flex h-18 max-w-container items-center justify-between px-5 py-4 lg:px-12">
          ...
          {links.map((l) => (
            <li key={l.href}>
              <Link
                ...
                onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = "rgba(248,244,237,0.55)")}
              >
                {l.label}
              </Link>
            </li>
        ...
        <div className="flex items-center gap-3">
          <Link
            href="#contact"
            className="hidden rounded-[10px] px-5 py-2.5 font-body text-sm font-semibold text-white transition-all duration-300 hover:-translate-y-px md:inline-flex"
            style={{
              background: "#005fff",
              boxShadow: "0 0 0 1px rgba(0,95,255,0.3)",
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLElement).style.boxShadow = "0 8px 24px rgba(0,95,255,0.45), 0 0 0 1px rgba(0,95,255,0.4)";
            }}
            onMouseLeave={(e) => {
              (e.currentTarget as HTMLElement).style.boxShadow = "0 0 0 1px rgba(0,95,255,0.3)";
            }}
          >
            Discutons
          </Link>
          <button
            ...
            style={{ border: "1px solid rgba(255,255,255,0.12)", color: "#f8f4ed" }}
      ...
      >
        <div className="flex h-16 items-center justify-between px-5" style={{ borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
          <span className="font-display text-xl font-semibold" style={{ color: "#f8f4ed" }}>Levo</span>
          <button
            type="button"
          ...
          {links.map((l) => (
            <li key={l.href}>
              <Link
                ...
                onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = "#f8f4ed")}
                onMouseLeave={(e) => ((e.currentTarget as HTMLElement).style.color = "rgba(248,244,237,0.7)")}
              >
                {l.label}
              </Link>
            </li>
